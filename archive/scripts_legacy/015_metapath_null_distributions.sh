...
#SBATCH --output=logs/null_computation/metapath_nulls/metapath_nulls_%j.out
#SBATCH --error=logs/null_computation/metapath_nulls/metapath_nulls_%j.err
#SBATCH --qos=normal
...
mkdir -p logs/null_computation/metapath_nulls
