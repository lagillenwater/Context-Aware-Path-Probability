...
#SBATCH --output=logs/null_computation/compositional/comp_null_opt_%j.out
#SBATCH --error=logs/null_computation/compositional/comp_null_opt_%j.err
#SBATCH --qos=normal
...
mkdir -p logs/null_computation/compositional
