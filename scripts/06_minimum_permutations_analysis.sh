...
# Define paths
input_notebook="${notebooks_path}/06_minimum_permutations_analysis.ipynb"
output_notebook="${notebooks_path}/executed/06_minimum_permutations_analysis_${EDGE_TYPE}_executed.ipynb"

echo "Input notebook: $input_notebook"
echo "Output notebook: $output_notebook"

# Create output directory if it doesn't exist
mkdir -p "${notebooks_path}/executed"
echo "Created output directory: ${notebooks_path}/executed"
