...
#SBATCH --mem=16G
#SBATCH --array=1-24
#SBATCH --output=../logs/analysis/degree/degree_analysis_%A_%a.out
#SBATCH --error=../logs/analysis/degree/degree_analysis_%A_%a.err

# Usage:
#   sbatch scripts/004.1_degree_analysis.sh
#
# Requirements:
