...
#SBATCH --output=logs/null_computation/dynamic_prog/dp_dwpc_16_%j.out
#SBATCH --error=logs/null_computation/dynamic_prog/dp_dwpc_16_%j.err
#SBATCH --qos=normal
...
mkdir -p logs/null_computation/dynamic_prog
