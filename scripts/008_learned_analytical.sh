...
#SBATCH --output=logs/analysis/learned_formula/learned_analytical_%A_%a.out
#SBATCH --error=logs/analysis/learned_formula/learned_analytical_%A_%a.err
...
logs_dir="${BASE_DIR}/logs/analysis/learned_formula"
